    ...
    export default {
        ...
        methods: {
            search() {
                const me = this
                if(me.searchText != '') {
                    me.$router.push(`/movie/search?query=${me.searchText}`)
                    me.searchText = ''
                }
            }
        },
